    ...
    <Html>
        ...
        <Body style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif', backgroundColor: '#f6f9fc', margin: '0 auto', padding: '20px 0' }}>
            <Container style={{ backgroundColor: '#ffffff', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', maxWidth: '600px', margin: '0 auto', overflow: 'hidden', padding: '0' }}>
                ...
                {/* Accent bar */}
                <Section style={{ backgroundColor: '#22c55e', padding: '4px 0' }} />
                ...
                <Section style={{ padding: '0 32px' }}>
                    ...
                    <Text style={{ color: '#374151', fontSize: '15px', margin: '0 0 24px' }}>
                        {adminName} approved your request to {actionPhrase(requestType, entryTitle, projectName)}.
                    </Text>
                </Section>

                {feedback && (
                    <Section style={{ padding: '0 32px 24px' }}>
                        <div style={{ backgroundColor: '#f0fdf4', border: '1px solid #bbf7d0', borderLeft: '4px solid #22c55e', borderRadius: '6px', padding: '14px 16px' }}>
                            <Text style={{ color: '#14532d', fontSize: '11px', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.05em', margin: '0 0 6px' }}>
                                Note from {adminName}
                            </Text>
                            <Text style={{ color: '#166534', fontSize: '14px', lineHeight: '1.6', margin: '0', whiteSpace: 'pre-wrap' }}>
                                {feedback}
                            </Text>
                        </div>
                    </Section>
                ...
                <Section style={{ padding: '0 32px 32px' }}>
                    <Button href={dashboardUrl} style={{ backgroundColor: '#22c55e', borderRadius: '6px', color: '#ffffff', fontSize: '14px', fontWeight: '600', textDecoration: 'none', display: 'inline-block', padding: '10px 20px' }}>
                        View Dashboard
                    </Button>
                </Section>
