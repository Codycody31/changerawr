...
interface Props {
    ...
    integration?: 'github' | 'gitlab'; // default github
}
...
export default function GitHubGenerateDialog({
    ...
    const providerName = integration === 'github' ? 'GitHub' : 'GitLab';
    const ProviderIcon = integration === 'github' ? Github : Gitlab;
    ...
    const loadTagsAndReleases = async () => {
        try {
            ...
            const response = await fetch(`/api/projects/${projectId}/integrations/${integration}/tags`);
            if (!response.ok) {
    ...
    const generateChangelog = async () => {
        try {
            ...
            const response = await fetch(`/api/projects/${projectId}/integrations/${integration}/generate`, {
                method: 'POST',
                ...
                <DialogTrigger asChild>
                    {trigger || (
                        <Button variant="outline" className="gap-2">
                            ...
                            {`Generate from ${providerName}`}
                        </Button>
                    )}
                </DialogTrigger>

                <DialogContent className="max-w-screen max-h-screen w-screen h-screen p-0 border-0 bg-background overflow-auto">
                    <DialogTitle className="sr-only">
                        Generate Changelog from {providerName} - Step {currentStep} of 3
                    </DialogTitle>
                    {/* Redirecting Overlay */}
                    <AnimatePresence>
                        {isRedirecting && (
                        ...
                        <div className="w-80 border-r bg-muted/20 flex flex-col">
                            ...
                            <div className="p-6 border-b">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <h1 className="text-lg font-bold">{providerName} Generator</h1>
