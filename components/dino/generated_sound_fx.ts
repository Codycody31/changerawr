...
export class GeneratedSoundFx {
    ...
    private bgSoundIntervalId: ReturnType<typeof setInterval>|null = null;
    ...
    jump() {
        ...
        const sq = (freq: number, dur: number, vol = 0.15, t = 0) => {
        ...
        sq(200, 0.06); sq(400, 0.06, 0.1, 0.06);
    }
    ...
    score() {
        const now = this.context.currentTime;
        this.playNote(523.25, now, 0.08, 0.2, 0);
        this.playNote(659.25, now + 0.08, 0.08, 0.2, 0);
        this.playNote(783.99, now + 0.16, 0.08, 0.2, 0);
    }
}