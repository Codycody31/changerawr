        ...
        variants: {
            variant: {
                default: [
                    ...
                    // Hover effects
                    "hover:after:bg-white/10 hover:scale-105",
                ...
                secondary: [
                    ...
                    "after:absolute after:inset-0 after:-z-10 after:rounded-full",
                    "hover:after:bg-foreground/5 hover:scale-105",
                ...
                outline: [
                    ...
                    "hover:bg-accent/30 hover:text-accent-foreground hover:border-border/80 hover:scale-105",
                    "dark:border-border/40",
                ],
                ghost: [
                    "border border-transparent bg-transparent text-foreground",
                    "hover:bg-accent/30 hover:text-accent-foreground hover:scale-105",
                ],
                success: [
