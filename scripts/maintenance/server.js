...
// Read the maintenance page HTML. docker-entrypoint.sh re-downloads this
// file (and this script) from GitHub before launching this server, so this
// is always whatever that refresh left on disk - the bundled copy is only
// used as a fallback if that refresh failed.
